...
class LapallinaWebViewApp extends StatefulWidget {
  const LapallinaWebViewApp({super.key});

  @override
  State<LapallinaWebViewApp> createState() => _RylivraWebViewAppState();
}

class _RylivraWebViewAppState extends State<LapallinaWebViewApp> {
